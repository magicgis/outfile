...
class WeiboCrawler(object):
    ...
    def get_username_password(self):
        ...
        # user_name_password2 = '942364283@qq.com:uwinvip'
    ...
    def __fetchSingleArticle(self, article):
        ...
        headers = {
            ...
            'User-Agent': '%s' % self.get_random_agent(),
            # 'cookie': '%s' % self.get_cookies()
        }
        ...
        html = self.session.get(article.url, headers=headers, params=data2)
    ...
    def crawlComment(self, article):
        ...
        html = self.session.get(re_url, params=data1, headers=headers)
