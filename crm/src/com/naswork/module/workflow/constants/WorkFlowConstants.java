...
public class WorkFlowConstants {
	...
	public enum ProcessKeys {
		TestProcess("TestProcess", "测试流程"),
		Ask4leaveProcess("Ask4leaveProcess", "请假流程"),
		PaymentProcess("PaymentProcess","付款审批"),
		ValidityProcess("ValidityProcess","有效期审批"),
		ContractreviewProcess("ContractreviewProcess","合同审批"),
		AbnormalpartProcess("AbnormalpartProcess","异常件审批")
		;
