...
public class TxtavQuoteElement {
    private Integer id;
    ...
    public Integer getTxtavQuoteId() {
        return txtavQuoteId;
    }

    public void setTxtavQuoteId(Integer txtavQuoteId) {
        this.txtavQuoteId = txtavQuoteId;
    }
