...
@Service("supplierInuquiryExcelGenerator")
public class SupplierInuquiryExcelGenerator extends ExcelGeneratorBase{
	@Resource
	...
	protected void writeData(POIExcelWorkBook wb,String ywId) {
		...
		List<ManageElementVo> elementList = new ArrayList<ManageElementVo>();
		if (ifAuto.equals("1")) {
			supplierInquiryService.ManageElementWhenAuto(new Integer(ywId));
		}else {
			elementList = supplierInquiryService.Elements(new Integer(ywId));
		}
					...
					if (cell != null) {
						...
						if (!StringUtils.isEmpty(cellKeys[cellnum
							...
							if (key.equals("ITEM")) {
								...
								Object value = manageElementVo.getBankCost();
								this.write(elementCell, value);
							}
						}
					}
