 ...
 *
 */
@Service("supplierWeatherQuoteExcelGenerator")
public class SupplierWeatherQuoteExcelGenerator extends ExcelGeneratorBase {
	...
	protected String fetchTemplateFileName(String currencyId) {
		return File.separator+"exceltemplate"+File.separator+"SupplierWeatherQuote.xls";
	}
	...
	protected void writeData(POIExcelWorkBook wb,String ywId) {
		...
		int codeCount = supplierCode.size()*2+size*2+1;
...
//				a++;
	...
	protected String fetchOutputFileName() {
		...
		return "SupplierWeatherQuote"+"_"+this.fetchUserName()+"_"+format.format(now);
	}
	...
	protected String fetchMappingKey() {
		return "SupplierWeatherQuotationExcel";
	}
