...
public class UserServiceImpl implements UserService {
	...
	public void powerList(PageModel<PowerVo> page,GridSort sort) {
		if(sort!=null){
			sort.setName(ConvertUtil.toDBName(sort.getName()));
	...
	public void insertPower(PowerVo powerVo) {
			/*List<Client> list = clientDao.findAll();
			for (int i = 0; i < list.size(); i++) {
				PowerVo powerVo2 = new PowerVo();
				powerVo2.setUserId(powerVo.getUserId());
				powerVo2.setClientId(list.get(i).getId());
				authorityRelationDao.insertSelective(powerVo2);
			}
			List<Supplier> list2 = supplierDao.Suppliers();
			for (int i = 0; i < list2.size(); i++) {
				PowerVo powerVo2 = new PowerVo();
				powerVo2.setUserId(powerVo.getUserId());
				powerVo2.setSupplierId(list2.get(i).getId());;
				authorityRelationDao.insertSelective(powerVo2);
			}*/
	...
	public void updatePower(AuthorityRelation authorityRelation) {
		authorityRelationDao.updateByPrimaryKeySelective(authorityRelation);
	}
	...
	public List<Integer> getLeadersByRole(Integer roleId){
		return userDao.getLeadersByRole(roleId);
	}
}
