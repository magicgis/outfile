...
<script type="text/javascript">
	...
	function completeTask(assignee){
		...
		var iframeId = 'taskFrame';
		var id = document.getElementById(iframeId).contentWindow.getData();
		if(id){
			$('#id').val(id);
		}else if(!id){
			return;
				...
				<div position="right" title="任务处理">
					...
					<div class="box-content box-content-jbyj">
						...
						<form id="form">
							...
							<textarea id="comment"  name="comment" clos="20" rows="5"  placeHolder="请填写经办意见"></textarea>
						</form>
						</p>
						<p id="outcomes">
						</p>
