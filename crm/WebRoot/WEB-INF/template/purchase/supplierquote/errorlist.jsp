...
<script type="text/javascript">
	...
	$(function() {
		...
		grid = PJ.grid("list1", {
			rowNum: 20,
			url:'<%=path%>/supplierquote/Unknow',
			width : PJ.getCenterWidth(),
			height : PJ.getCenterHeight()-142,
			autoSrcoll:true,
			//shrinkToFit:false,
			colNames :["id","行","件号","错误描述"],
			colModel :[PJ.grid_column("id", {key:true,hidden:true}),
			           PJ.grid_column("sn", {sortable:true,width:60,align:'left'}),
			           PJ.grid_column("partNumber", {sortable:true,width:130,align:'left'}),
			           PJ.grid_column("message",{sortable:true,width:200,align:'left'})
			           ]
		});
