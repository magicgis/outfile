...
<script type="text/javascript">
	...
	$(function() {
		...
		grid2 = PJ.grid("list2", {
			...
			colNames : ["id","客户Id", "客户参考号"],
			colModel : [ PJ.grid_column("id", {sortable:true,width:100,key:true,hidden:true}),
			             PJ.grid_column("clientId", {sortable:true,width:100,hidden:true}),
		    ...
		    if(e.which == 13) {
		    	var rowKey = grid.getGridParam("selarrrow");
				 if(rowKey!= ""){
				 	...
				 	PJ.grid_search(grid2,'<%=path%>/supplierquote/clientinquirydata?airTypeId='+postData.airTypeId);
				 }else{
...
<body>
	...
	<div id="layout_main" style="float: right;width: 78%; margin: 0; padding: 0">
		<div id="toolbar"></div>
			<div id="searchdiv" style="width: 100%;height: 90px;display: block;">
		 <form id="searchForm">
		<input type="text" class="hide" name="client" value="1">
			<input type="text" class="hide" name="clientId" id="clientId" value="1">
					...
					<form:column>
						...
						<form:column>
							    ...
							    <form:right><p><input id="quoteNumber" type="text"  prefix="" name="quoteNumber"  class="text" oper="cn" alias="quote_number or source_number" value=""/></p></form:right>
							   	</form:column>
					...
					<form:row columnNum="2">
						<form:column>
								...
								<form:right><p>
												<select id="searchForm1" name="clientCode" alias="client_id" oper="eq"style="width: 138px">
