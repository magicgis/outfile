	...
	<table id="elementTable" border="1px">
		...
		<c:forEach var="message" items="${list}" >
			<tr>
				...
				<td><input type="text" name="quotePartNumber" alia="read" value="${message.inquiryPartNumber}"/></td>
				<td><input type="text" name="description" alia="read" value="${message.inquiryDescription}"/></td>
				<td><input style="width: 80px" type="text" alia="read" name="price"/></td>
				<td><input style="width: 80px" type="text" alia="read" name="unit" value="${message.inquiryUnit}"/></td>
				...
				<td><input type="text" style="width: 80px" name="fixedCost" alia="read"value="${message.fixedCost}"/></td>
				<td><input type="text" style="width: 80px" name="bankCharges" alia="read"value="${message.bankCharges}"/></td>
