...
$(function(){
	layout = $("#layout1").ligerLayout();
	 ...
	 grid = PJ.grid("list1", {
			...
			inLineEdit: true,
			shrinkToFit:false,
			colNames :["id","taskId","clientOrderElementId","item","csn","件号","描述","数量","MOQ","单价",
			           "周期","佣金","银行费用","供应商","单价","银行费","提货换单费","危险品费","杂费","数量","总价","备注","利润率","利润","利润标准","流程图","经办意见"],
					colModel :[  PJ.grid_column("id", {key:true,editable:true,hidden:true}),
						        ...
						        PJ.grid_column("supplierOrderPrice", {sortable:true,width:60,align:'left',formatter:function(value){
										if(value>0){
								...
								PJ.grid_column("quoteFeeForExchangeBill", {sortable:true,width:50,align:'left'}),
								PJ.grid_column("quoteHazmatFee", {sortable:true,width:50,align:'left'}),
								PJ.grid_column("quoteOtherFee", {sortable:true,width:50,align:'left'}),
								PJ.grid_column("weatherOrderAmount", {sortable:true,width:50,align:'left'}),
								PJ.grid_column("total", {sortable:true,width:50,align:'left' ,formatter:function(value){
									if(value>0){
										return value.toFixed(2);
									}
									else{
				...
				grid.jqGrid('setGroupHeaders', { 
				 	...
				 	groupHeaders:[ 
				 		...
				 		{startColumnName: 'code', numberOfColumns:  9, titleText: '<div align="center"><span>供应商订单</span></div>'},
