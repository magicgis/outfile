...
$(function(){
	...
	grid = PJ.grid("list1", {
		...
		multiselect:true,
		inLineEdit: true,
		editurl:'<%=path%>/sales/clientorder/updateFinalElement',
		//shrinkToFit:false,
	colNames :["id","taskId","clientOrderElementId","件号","描述","流程图","供应商价格","订单价格","订单数量","","状态","利润率","利润率标准","经办意见"],
			colModel :[PJ.grid_column("id", {key:true,hidden:true,editable:true,}),
			           ...
			           PJ.grid_column("orderPrice", {sortable:true,width:30,align:'left',editable:true}),
			           PJ.grid_column("orderAmount", {sortable:true,width:30,align:'left',editable:true}),
			           PJ.grid_column("orderStatusId",{sortable:true,width:60,align:'left',hidden:true}),
				       PJ.grid_column("orderStatusValue", {sortable:true,width:30,editable:true,align:'left',
