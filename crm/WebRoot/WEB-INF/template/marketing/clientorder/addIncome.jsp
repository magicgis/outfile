...
<div position="center" title="新增收款">
	...
	<input name="clientInvoiceId" id="clientInvoiceId" class="hide" value="${clientInvoice.id }"/>
	<table>
		<tr>
			<td>订单号</td>
		...
		<tr>
			<td>收款日期</td>
			<td><input name="receiveDate" id="RECEIVE_DATE" class="text" class="tc" value="<fmt:formatDate value="${today }"  pattern="yyyy-MM-dd"/>"/></td>
		</tr>
		<tr>
			<td>备注</td>
