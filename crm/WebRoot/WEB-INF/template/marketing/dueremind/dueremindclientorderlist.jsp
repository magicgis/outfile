...
<script type="text/javascript">
	...
	$(function() {
		...
		grid = PJ.grid("list", {
			rowNum: 20,
			url:'<%=path%>/dueremind/listDataByClientOrder',
		...
		$(document).keypress(function(e) {
			// 回车键事件  
		    if(e.which == 13) {
		    	PJ.grid_search(grid,'<%=path%>/dueremind/listDataByClientOrder');
		    }  
		}); 
