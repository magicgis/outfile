	...
	$(function(){
			$("#cageCode").blur(function(){
				...
				$.ajax({
					type: "POST",
					dataType: "json",
					url:'<%=path%>/suppliermanage/?cageCode='+cageCode+'&supplierId='+${supplierId},
					success:function(result){
						if(result.success){
							$("#msg").html("该cage_code已增加");
						}else{
							$("#msg").html(" ");
						}
					}
...
<div position="center" title="新增厂商">
	<form id="addForm" action="">
	<table>
		<tr>
			<td>cageCode</td>
			<td>
				<input name="cageCode" id="cageCode"/><span id="msg"></span>
			</td>
		</tr>
	</table>
	</form>
