...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url:'<%=path%>/system/competitormanage/currency?edit=1&id='+${competitor.id},
			success:function(result){
...
<div position="center" title="修改竞争对手">
	<form id="addForm" action="">
	<input class="hide" id="id" name="id" value="${competitor.id}"/>
	<table>
		<tr>
			<td>代码</td>
		...
		<tr>
			<td>名称</td>
			<td><input name="name" id="name" class="text" value="${competitor.name}"/></td>
		</tr>
		<tr>
			<td>币种</td>
		...
		<tr>
			<td>备注</td>
			<td><textarea rows="7" cols="90" name="remark" id="remark">${competitor.remark}</textarea></td>
		</tr>
