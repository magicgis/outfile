...
<div position="center" title="新增类型">
	<form id="addForm" action="">
	<input name="id" id="id" class="hide" value="${partTypeParent.id }"/>
	<table>
		<tr>
			<td>类型</td>
			<td><input name="type" id="type" class="text" value="${partTypeParent.type }"/><span id="msg"></span></td>
		</tr>
		<tr>
			<td>备注</td>
			<td><textarea rows="7" cols="90" name="remark" id="remark" >${partTypeParent.remark }</textarea></td>
		</tr>
