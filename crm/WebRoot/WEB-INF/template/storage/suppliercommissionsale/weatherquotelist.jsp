...
<script type="text/javascript">
	...
	$(function() {
		...
		PJ.ajax({
			 url: "<%=path%>/supplierquote/list/dynamicColNames?id="+"${id}",
			 dataType:'json',	
			 loading: "正在加载...",
			   success: function(result) {
				   ...
				   var colModel = [PJ.grid_column("id", {sortable:true,hidden:true,editable:true}),
						            ...
						            PJ.grid_column("item", {sortable:true,width:40}),
						            PJ.grid_column("partNumber", {sortable:true,width:100}),
						            PJ.grid_column("airType", {sortable:true,width:60}),
						            PJ.grid_column("description", {sortable:true}),
						            PJ.grid_column("unit", {sortable:true,width:50}),
						            PJ.grid_column("amount", {sortable:true,width:40})
									];
	...
	function Excel(){
			...
			var businessKey = "";
			var id=0+"-"+'${id}';
			businessKey='supplier_weather_quote_for_commission.id.'+id+'.SupplierWeatherQuotationFroCommissionExcel';
