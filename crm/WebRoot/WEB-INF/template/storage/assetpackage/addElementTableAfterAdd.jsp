...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#submit").click(function(){
            ...
            var url = '<%=path%>/storage/assetpackage/uploadExcel?id='+getExcelFormData().id;
            //批量新增来函案源
	   	 	$.ajaxFileUpload({  
	            url: url,
	            secureuri:false,
...
<body>
	...
	<table id="elementTable" border="1px" style="table-layout:fixed ">
		<thead>
			<tr>
				<th></th>
				...
				<th style="text-align: center;">AR 评估价格</th>
		...
		<tbody>
			<tr>
				...
				<td><input type="text" class='isnull' name="partNumber"/></td>
				...
				<td><input type="text" name="arPrice"/></td>
