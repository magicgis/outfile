...
<script type="text/javascript">
	...
	$(function() {
		...
		grid = PJ.grid("list1", {
			rowNum: 20,
			url:'<%=path%>/finance/invoice/proformaInvoiceListData',
			...
			sortorder : "desc",
			colNames :["id","clientOrderId","clientId","客户","发票号","订单号","发票类型","开票日期","开票金额","开票比例","备注","更新时间"],
			colModel :[PJ.grid_column("id", {key:true,hidden:true}),
			           ...
			           PJ.grid_column("invoiceType",{sortable:true,width:120,align:'left',
		...
		$(document).keypress(function(e) {
			// 回车键事件  
		    if(e.which == 13) {
		    	PJ.grid_search(grid,'<%=path%>/finance/invoice/proformaInvoiceListData');
		    }  
		});
