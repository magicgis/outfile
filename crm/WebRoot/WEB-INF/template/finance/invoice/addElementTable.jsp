	...
	<table id="elementTable" border="1px">
		...
		<c:forEach var="message" items="${list}" >
			<tr>
				...
				<td><input type="text" name="quoteDescription" readonly="readonly"value="${message.quoteDescription}"/></td>
				<td><input style="width: 80px" type="text"readonly="readonly" name="quoteUnit"value="${message.quoteUnit}"/></td>
				<td><input style="width: 80px" type="text" readonly="readonly"name="quoteAmount"value="<fmt:formatNumber type="number" 
            maxFractionDigits="3" value="${message.clientOrderAmount}"/>"/></td>
				<td><input style="width: 80px" type="text"readonly="readonly" name="clientOrderPrice"value="${message.clientOrderPrice}"/></td>
				<td><input style="width: 80px" type="text" name="amount"   value="<fmt:formatNumber value="${message.clientOrderAmount}" pattern="0"/>"/></td>
				<td><input style="width: 80px" type="text" name="terms" value="<fmt:formatNumber value="${message.invoiceTerms}" pattern="0"/>"/></td>
				<td><input type="text" name="remark" value="${message.remark}"/></td>
				<td><input type="text" name="clientInvoiceId" class="hide" value="${message.clientInvoiceId}"/></td>
