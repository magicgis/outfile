...
/*游客逗留时间*/
@RestController
@RequestMapping("/v2/qsdlsjfx")
public class QsdlsjfxControlller extends BaseController {
	@Resource
	...
	public HashMap<String, Object> getYkdlsj(@PathVariable Integer year_id, @PathVariable Integer month_id) {
